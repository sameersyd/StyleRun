...
public class com_styleway_app_models_MyStringRealmProxy extends com.styleway.app.models.MyString
    implements RealmObjectProxy, com_styleway_app_models_MyStringRealmProxyInterface {
    ...
    com_styleway_app_models_MyStringRealmProxy() {
    ...
    public static com.styleway.app.models.MyString createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        final com_styleway_app_models_MyStringRealmProxyInterface objProxy = (com_styleway_app_models_MyStringRealmProxyInterface) obj;
        if (json.has("string")) {
    ...
    public static com.styleway.app.models.MyString copy(Realm realm, com.styleway.app.models.MyString newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com_styleway_app_models_MyStringRealmProxyInterface realmObjectSource = (com_styleway_app_models_MyStringRealmProxyInterface) newObject;
        com_styleway_app_models_MyStringRealmProxyInterface realmObjectCopy = (com_styleway_app_models_MyStringRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.styleway.app.models.MyString object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$string = ((com_styleway_app_models_MyStringRealmProxyInterface) object).realmGet$string();
    ...
    public static com.styleway.app.models.MyString createDetachedCopy(com.styleway.app.models.MyString realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_styleway_app_models_MyStringRealmProxyInterface unmanagedCopy = (com_styleway_app_models_MyStringRealmProxyInterface) unmanagedObject;
        com_styleway_app_models_MyStringRealmProxyInterface realmSource = (com_styleway_app_models_MyStringRealmProxyInterface) realmObject;
