...
public class com_styleway_app_models_GroupRealmProxy extends com.styleway.app.models.Group
    implements RealmObjectProxy, com_styleway_app_models_GroupRealmProxyInterface {
    ...
    com_styleway_app_models_GroupRealmProxy() {
    ...
    public static com.styleway.app.models.Group createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    ...
                    obj = new io.realm.com_styleway_app_models_GroupRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_styleway_app_models_GroupRealmProxy) realm.createObjectInternal(com.styleway.app.models.Group.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_styleway_app_models_GroupRealmProxy) realm.createObjectInternal(com.styleway.app.models.Group.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_styleway_app_models_GroupRealmProxyInterface objProxy = (com_styleway_app_models_GroupRealmProxyInterface) obj;
        if (json.has("name")) {
            if (json.isNull("name")) {
    ...
    public static com.styleway.app.models.Group copyOrUpdate(Realm realm, com.styleway.app.models.Group object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (canUpdate) {
            ...
            GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.styleway.app.models.Group.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_styleway_app_models_GroupRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.styleway.app.models.Group.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_styleway_app_models_GroupRealmProxy();
    ...
    public static com.styleway.app.models.Group copy(Realm realm, com.styleway.app.models.Group newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.styleway.app.models.Group realmObject = realm.createObjectInternal(com.styleway.app.models.Group.class, ((com_styleway_app_models_GroupRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_styleway_app_models_GroupRealmProxyInterface realmObjectSource = (com_styleway_app_models_GroupRealmProxyInterface) newObject;
        com_styleway_app_models_GroupRealmProxyInterface realmObjectCopy = (com_styleway_app_models_GroupRealmProxyInterface) realmObject;
        ...
        if (userIdsList != null) {
            ...
            for (int i = 0; i < userIdsList.size(); i++) {
                ...
                if (cacheuserIds != null) {
                    ...
                    userIdsRealmList.add(com_styleway_app_models_MyStringRealmProxy.copyOrUpdate(realm, userIdsItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.styleway.app.models.Group object, Map<RealmModel,Long> cache) {
        ...
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.styleway.app.models.Group.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_styleway_app_models_GroupRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$name = ((com_styleway_app_models_GroupRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$status = ((com_styleway_app_models_GroupRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$image = ((com_styleway_app_models_GroupRealmProxyInterface) object).realmGet$image();
        if (realmGet$image != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.imageIndex, rowIndex, realmGet$image, false);
        }

        RealmList<com.styleway.app.models.MyString> userIdsList = ((com_styleway_app_models_GroupRealmProxyInterface) object).realmGet$userIds();
        if (userIdsList != null) {
            ...
            for (com.styleway.app.models.MyString userIdsItem : userIdsList) {
                ...
                if (cacheItemIndexuserIds == null) {
                    cacheItemIndexuserIds = com_styleway_app_models_MyStringRealmProxy.insert(realm, userIdsItem, cache);
                }
    ...
    public static long insertOrUpdate(Realm realm, com.styleway.app.models.Group object, Map<RealmModel,Long> cache) {
        ...
        if (userIdsList != null && userIdsList.size() == userIdsOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexuserIds = cache.get(userIdsItem);
                if (cacheItemIndexuserIds == null) {
                    cacheItemIndexuserIds = com_styleway_app_models_MyStringRealmProxy.insertOrUpdate(realm, userIdsItem, cache);
                }
    ...
    public static com.styleway.app.models.Group createDetachedCopy(com.styleway.app.models.Group realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_styleway_app_models_GroupRealmProxyInterface unmanagedCopy = (com_styleway_app_models_GroupRealmProxyInterface) unmanagedObject;
        com_styleway_app_models_GroupRealmProxyInterface realmSource = (com_styleway_app_models_GroupRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            for (int i = 0; i < size; i++) {
                com.styleway.app.models.MyString item = com_styleway_app_models_MyStringRealmProxy.createDetachedCopy(manageduserIdsList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.styleway.app.models.Group update(Realm realm, com.styleway.app.models.Group realmObject, com.styleway.app.models.Group newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_styleway_app_models_GroupRealmProxyInterface realmObjectTarget = (com_styleway_app_models_GroupRealmProxyInterface) realmObject;
        com_styleway_app_models_GroupRealmProxyInterface realmObjectSource = (com_styleway_app_models_GroupRealmProxyInterface) newObject;
        ...
        if (userIdsList != null && userIdsList.size() == userIdsRealmList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                if (cacheuserIds != null) {
                    ...
                    userIdsRealmList.set(i, com_styleway_app_models_MyStringRealmProxy.copyOrUpdate(realm, userIdsItem, true, cache));
                }
            }
        } else {
            userIdsRealmList.clear();
            if (userIdsList != null) {
                for (int i = 0; i < userIdsList.size(); i++) {
                    ...
                    if (cacheuserIds != null) {
                        ...
                        userIdsRealmList.add(com_styleway_app_models_MyStringRealmProxy.copyOrUpdate(realm, userIdsItem, true, cache));
                    }
                }
            }
        }
