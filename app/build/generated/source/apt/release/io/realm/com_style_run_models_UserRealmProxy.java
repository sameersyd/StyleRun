...
public class com_style_run_models_UserRealmProxy extends com.styleway.app.models.User
    implements RealmObjectProxy, com_style_run_models_UserRealmProxyInterface {
    ...
    com_style_run_models_UserRealmProxy() {
    ...
    public static com.styleway.app.models.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    ...
                    obj = new io.realm.com_style_run_models_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_style_run_models_UserRealmProxy) realm.createObjectInternal(com.styleway.app.models.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_style_run_models_UserRealmProxy) realm.createObjectInternal(com.styleway.app.models.User.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_style_run_models_UserRealmProxyInterface objProxy = (com_style_run_models_UserRealmProxyInterface) obj;
    ...
    public static com.styleway.app.models.User copyOrUpdate(Realm realm, com.styleway.app.models.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (canUpdate) {
            ...
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.styleway.app.models.User.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_style_run_models_UserRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.styleway.app.models.User.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_style_run_models_UserRealmProxy();
    ...
    public static com.styleway.app.models.User copy(Realm realm, com.styleway.app.models.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.styleway.app.models.User realmObject = realm.createObjectInternal(com.styleway.app.models.User.class, ((com_style_run_models_UserRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_style_run_models_UserRealmProxyInterface realmObjectSource = (com_style_run_models_UserRealmProxyInterface) newObject;
        com_style_run_models_UserRealmProxyInterface realmObjectCopy = (com_style_run_models_UserRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.styleway.app.models.User object, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.styleway.app.models.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_style_run_models_UserRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$nameInPhone = ((com_style_run_models_UserRealmProxyInterface) object).realmGet$nameInPhone();
        ...
        String realmGet$name = ((com_style_run_models_UserRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$status = ((com_style_run_models_UserRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$image = ((com_style_run_models_UserRealmProxyInterface) object).realmGet$image();
    ...
    public static com.styleway.app.models.User createDetachedCopy(com.styleway.app.models.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_style_run_models_UserRealmProxyInterface unmanagedCopy = (com_style_run_models_UserRealmProxyInterface) unmanagedObject;
        com_style_run_models_UserRealmProxyInterface realmSource = (com_style_run_models_UserRealmProxyInterface) realmObject;
    ...
    static com.styleway.app.models.User update(Realm realm, com.styleway.app.models.User realmObject, com.styleway.app.models.User newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_style_run_models_UserRealmProxyInterface realmObjectTarget = (com_style_run_models_UserRealmProxyInterface) realmObject;
        com_style_run_models_UserRealmProxyInterface realmObjectSource = (com_style_run_models_UserRealmProxyInterface) newObject;
