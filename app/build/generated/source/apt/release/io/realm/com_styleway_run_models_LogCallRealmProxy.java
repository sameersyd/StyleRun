...
public class com_styleway_run_models_LogCallRealmProxy extends com.styleway.app.models.LogCall
    implements RealmObjectProxy, com_styleway_run_models_LogCallRealmProxyInterface {
    ...
    com_styleway_run_models_LogCallRealmProxy() {
    ...
    public static com.styleway.app.models.LogCall createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        final com_styleway_run_models_LogCallRealmProxyInterface objProxy = (com_styleway_run_models_LogCallRealmProxyInterface) obj;
    ...
    public static com.styleway.app.models.LogCall copy(Realm realm, com.styleway.app.models.LogCall newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com_styleway_run_models_LogCallRealmProxyInterface realmObjectSource = (com_styleway_run_models_LogCallRealmProxyInterface) newObject;
        com_styleway_run_models_LogCallRealmProxyInterface realmObjectCopy = (com_styleway_run_models_LogCallRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.styleway.app.models.LogCall object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeDurationSecondsIndex, rowIndex, ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$timeDurationSeconds(), false);
        String realmGet$status = ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$myId = ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$userName = ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$userName();
        if (realmGet$userName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userNameIndex, rowIndex, realmGet$userName, false);
        }
        String realmGet$userImage = ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$userImage();
        ...
        String realmGet$userStatus = ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$userStatus();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVideoIndex, rowIndex, ((com_styleway_run_models_LogCallRealmProxyInterface) object).realmGet$isVideo(), false);
        return rowIndex;
    }
    ...
    public static com.styleway.app.models.LogCall createDetachedCopy(com.styleway.app.models.LogCall realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_styleway_run_models_LogCallRealmProxyInterface unmanagedCopy = (com_styleway_run_models_LogCallRealmProxyInterface) unmanagedObject;
        com_styleway_run_models_LogCallRealmProxyInterface realmSource = (com_styleway_run_models_LogCallRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_styleway_run_models_LogCallRealmProxy aLogCall = (com_styleway_run_models_LogCallRealmProxy)o;
