...
public class com_styleway_app_models_MessageRealmProxy extends com.styleway.app.models.Message
    implements RealmObjectProxy, com_styleway_app_models_MessageRealmProxyInterface {
    ...
    com_styleway_app_models_MessageRealmProxy() {
    ...
    public static com.styleway.app.models.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        final com_styleway_app_models_MessageRealmProxyInterface objProxy = (com_styleway_app_models_MessageRealmProxyInterface) obj;
        ...
        if (json.has("recipientGroupIds")) {
            if (json.isNull("recipientGroupIds")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.styleway.app.models.MyString item = com_styleway_app_models_MyStringRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
        ...
        if (json.has("attachment")) {
            if (json.isNull("attachment")) {
                ...
                com.styleway.app.models.Attachment attachmentObj = com_styleway_app_models_AttachmentRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("attachment"), update);
        ...
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.styleway.app.models.MyString item = com_styleway_app_models_MyStringRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$recipientGroupIds().add(item);
                    }
                    reader.endArray();
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.styleway.app.models.Attachment attachmentObj = com_styleway_app_models_AttachmentRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$attachment(attachmentObj);
                }
            } else {
                reader.skipValue();
    ...
    public static com.styleway.app.models.Message copy(Realm realm, com.styleway.app.models.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com_styleway_app_models_MessageRealmProxyInterface realmObjectSource = (com_styleway_app_models_MessageRealmProxyInterface) newObject;
        com_styleway_app_models_MessageRealmProxyInterface realmObjectCopy = (com_styleway_app_models_MessageRealmProxyInterface) realmObject;
        ...
        if (recipientGroupIdsList != null) {
            ...
            for (int i = 0; i < recipientGroupIdsList.size(); i++) {
                ...
                if (cacherecipientGroupIds != null) {
                    ...
                    recipientGroupIdsRealmList.add(com_styleway_app_models_MyStringRealmProxy.copyOrUpdate(realm, recipientGroupIdsItem, update, cache));
                }
            }
        }
        ...
        if (attachmentObj == null) {
            ...
            if (cacheattachment != null) {
                ...
                realmObjectCopy.realmSet$attachment(com_styleway_app_models_AttachmentRealmProxy.copyOrUpdate(realm, attachmentObj, update, cache));
            }
        }
        return realmObject;
    }
    ...
    public static long insert(Realm realm, com.styleway.app.models.Message object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$senderName = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderImage = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$senderImage();
        ...
        String realmGet$senderStatus = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$senderStatus();
        ...
        String realmGet$recipientName = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$recipientName();
        ...
        String realmGet$recipientImage = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$recipientImage();
        ...
        String realmGet$recipientStatus = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$recipientStatus();
        ...
        String realmGet$body = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$id = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$recipientId = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$recipientId();
        ...
        String realmGet$senderId = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }

        RealmList<com.styleway.app.models.MyString> recipientGroupIdsList = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$recipientGroupIds();
        if (recipientGroupIdsList != null) {
            ...
            for (com.styleway.app.models.MyString recipientGroupIdsItem : recipientGroupIdsList) {
                ...
                if (cacheItemIndexrecipientGroupIds == null) {
                    cacheItemIndexrecipientGroupIds = com_styleway_app_models_MyStringRealmProxy.insert(realm, recipientGroupIdsItem, cache);
                }
                recipientGroupIdsOsList.addRow(cacheItemIndexrecipientGroupIds);
            }
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$attachmentType(), false);

        com.styleway.app.models.Attachment attachmentObj = ((com_styleway_app_models_MessageRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_styleway_app_models_AttachmentRealmProxy.insert(realm, attachmentObj, cache);
            }
    ...
    public static long insertOrUpdate(Realm realm, com.styleway.app.models.Message object, Map<RealmModel,Long> cache) {
        ...
        if (recipientGroupIdsList != null && recipientGroupIdsList.size() == recipientGroupIdsOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexrecipientGroupIds = cache.get(recipientGroupIdsItem);
                if (cacheItemIndexrecipientGroupIds == null) {
                    cacheItemIndexrecipientGroupIds = com_styleway_app_models_MyStringRealmProxy.insertOrUpdate(realm, recipientGroupIdsItem, cache);
                }
        ...
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_styleway_app_models_AttachmentRealmProxy.insertOrUpdate(realm, attachmentObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.attachmentIndex, rowIndex, cacheattachment, false);
        } else {
    ...
    public static com.styleway.app.models.Message createDetachedCopy(com.styleway.app.models.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_styleway_app_models_MessageRealmProxyInterface unmanagedCopy = (com_styleway_app_models_MessageRealmProxyInterface) unmanagedObject;
        com_styleway_app_models_MessageRealmProxyInterface realmSource = (com_styleway_app_models_MessageRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            for (int i = 0; i < size; i++) {
                com.styleway.app.models.MyString item = com_styleway_app_models_MyStringRealmProxy.createDetachedCopy(managedrecipientGroupIdsList.get(i), nextDepth, maxDepth, cache);
        ...
        unmanagedCopy.realmSet$attachment(com_styleway_app_models_AttachmentRealmProxy.createDetachedCopy(realmSource.realmGet$attachment(), currentDepth + 1, maxDepth, cache));
