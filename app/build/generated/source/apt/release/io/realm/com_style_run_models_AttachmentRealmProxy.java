...
public class com_style_run_models_AttachmentRealmProxy extends com.styleway.app.models.Attachment
    implements RealmObjectProxy, com_style_run_models_AttachmentRealmProxyInterface {
    ...
    com_style_run_models_AttachmentRealmProxy() {
    ...
    public static com.styleway.app.models.Attachment createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        final com_style_run_models_AttachmentRealmProxyInterface objProxy = (com_style_run_models_AttachmentRealmProxyInterface) obj;
        if (json.has("name")) {
            if (json.isNull("name")) {
    ...
    public static com.styleway.app.models.Attachment copy(Realm realm, com.styleway.app.models.Attachment newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com_style_run_models_AttachmentRealmProxyInterface realmObjectSource = (com_style_run_models_AttachmentRealmProxyInterface) newObject;
        com_style_run_models_AttachmentRealmProxyInterface realmObjectCopy = (com_style_run_models_AttachmentRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.styleway.app.models.Attachment object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$name = ((com_style_run_models_AttachmentRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$data = ((com_style_run_models_AttachmentRealmProxyInterface) object).realmGet$data();
        if (realmGet$data != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dataIndex, rowIndex, realmGet$data, false);
        }
        String realmGet$url = ((com_style_run_models_AttachmentRealmProxyInterface) object).realmGet$url();
        if (realmGet$url != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.urlIndex, rowIndex, realmGet$url, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.bytesCountIndex, rowIndex, ((com_style_run_models_AttachmentRealmProxyInterface) object).realmGet$bytesCount(), false);
        return rowIndex;
    }
    ...
    public static com.styleway.app.models.Attachment createDetachedCopy(com.styleway.app.models.Attachment realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_style_run_models_AttachmentRealmProxyInterface unmanagedCopy = (com_style_run_models_AttachmentRealmProxyInterface) unmanagedObject;
        com_style_run_models_AttachmentRealmProxyInterface realmSource = (com_style_run_models_AttachmentRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_style_run_models_AttachmentRealmProxy aAttachment = (com_style_run_models_AttachmentRealmProxy)o;
