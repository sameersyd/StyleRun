...
public class com_styleway_run_models_ChatRealmProxy extends com.styleway.app.models.Chat
    implements RealmObjectProxy, com_styleway_run_models_ChatRealmProxyInterface {
    ...
    com_styleway_run_models_ChatRealmProxy() {
    ...
    public static com.styleway.app.models.Chat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        final com_styleway_run_models_ChatRealmProxyInterface objProxy = (com_styleway_run_models_ChatRealmProxyInterface) obj;
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.styleway.app.models.Message item = com_styleway_run_models_MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
        ...
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.styleway.app.models.Message item = com_styleway_run_models_MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.styleway.app.models.Chat copy(Realm realm, com.styleway.app.models.Chat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com_styleway_run_models_ChatRealmProxyInterface realmObjectSource = (com_styleway_run_models_ChatRealmProxyInterface) newObject;
        com_styleway_run_models_ChatRealmProxyInterface realmObjectCopy = (com_styleway_run_models_ChatRealmProxyInterface) realmObject;
        ...
        if (messagesList != null) {
            ...
            for (int i = 0; i < messagesList.size(); i++) {
                ...
                if (cachemessages != null) {
                    ...
                    messagesRealmList.add(com_styleway_run_models_MessageRealmProxy.copyOrUpdate(realm, messagesItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.styleway.app.models.Chat object, Map<RealmModel,Long> cache) {
        ...
        RealmList<com.styleway.app.models.Message> messagesList = ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            ...
            for (com.styleway.app.models.Message messagesItem : messagesList) {
                ...
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_styleway_run_models_MessageRealmProxy.insert(realm, messagesItem, cache);
                }
                messagesOsList.addRow(cacheItemIndexmessages);
            }
        }
        String realmGet$lastMessage = ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$chatId = ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdIndex, rowIndex, realmGet$chatId, false);
        }
        String realmGet$chatName = ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$chatName();
        if (realmGet$chatName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatNameIndex, rowIndex, realmGet$chatName, false);
        }
        String realmGet$chatImage = ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$chatImage();
        ...
        String realmGet$chatStatus = ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$chatStatus();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$read(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.groupIndex, rowIndex, ((com_styleway_run_models_ChatRealmProxyInterface) object).realmGet$group(), false);
        return rowIndex;
    }
    ...
    public static long insertOrUpdate(Realm realm, com.styleway.app.models.Chat object, Map<RealmModel,Long> cache) {
        ...
        if (messagesList != null && messagesList.size() == messagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_styleway_run_models_MessageRealmProxy.insertOrUpdate(realm, messagesItem, cache);
                }
    ...
    public static com.styleway.app.models.Chat createDetachedCopy(com.styleway.app.models.Chat realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        com_styleway_run_models_ChatRealmProxyInterface unmanagedCopy = (com_styleway_run_models_ChatRealmProxyInterface) unmanagedObject;
        com_styleway_run_models_ChatRealmProxyInterface realmSource = (com_styleway_run_models_ChatRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            for (int i = 0; i < size; i++) {
                com.styleway.app.models.Message item = com_styleway_run_models_MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        com_styleway_run_models_ChatRealmProxy aChat = (com_styleway_run_models_ChatRealmProxy)o;
