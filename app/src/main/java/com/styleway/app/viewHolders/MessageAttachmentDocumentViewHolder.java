...
import com.styleway.app.utils.MyFileProvider;
...
public class MessageAttachmentDocumentViewHolder extends BaseMessageViewHolder {
    ...
    public MessageAttachmentDocumentViewHolder(View itemView, OnMessageItemClick itemClickListener) {
        ...
        fileExtention.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        fileExtention.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        fileSize.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                onItemClick(false);
                return true;
