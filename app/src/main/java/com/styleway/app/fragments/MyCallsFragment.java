...
import com.styleway.app.adapters.LogCallAdapter;
...
import com.styleway.app.views.MyRecyclerView;
...
public class MyCallsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        chatAdapter = new LogCallAdapter(getActivity(), logCallDataList, userMe);
